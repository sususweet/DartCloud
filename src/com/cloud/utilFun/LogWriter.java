...
public class LogWriter {
	...
	// 默认的日志文件的路径和文件名称
	private final String WIN_DEFAULT_LOG_FILE_NAME = "e:\\dartcloud.log";
	private final String LIN_DEFAULT_LOG_FILE_NAME = "/var/log/dartcloud.log";
	...
	private void init() {
		...
		if (this.logFileName == null) {
			...
			if (this.logFileName == null) {
				if ( getSystemName().equals("win") )
					this.logFileName = WIN_DEFAULT_LOG_FILE_NAME;
				else
					this.logFileName = LIN_DEFAULT_LOG_FILE_NAME;
			}
	...
	private String getSystemName() {
		...
		if ( null != sys && ( sys.indexOf("win")!=-1 || sys.indexOf("Win")!=-1 ) ) {  
            return "win";
        } 
		return "linux";
	}
